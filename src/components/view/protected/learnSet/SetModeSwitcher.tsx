...
const SetModeSwitcher: FC<{ checked: boolean, setChecked: Dispatch<SetStateAction<boolean>> }> = ({
                                                                                                      checked,
                                                                                                      setChecked
                                                                                                  }) => {
    ...
    return (
        <Switch checked={checked}>
            ...
            <StyledLabel htmlFor="" checked={checked}>
                <StyledSpan>Pokaż słowa</StyledSpan>
            </StyledLabel>
        </Switch>
    );
};

export default SetModeSwitcher;